	...
	InitializingBean sendDatabase() {
	    return () -> {
	    	 //Tribe details
			  ...
			  groupReferenceRepo.save(new GroupReference("FT","CMT", "SGCIB Client Onboarding team","bookmarkApp",new Date(System.currentTimeMillis()))); 
			  groupReferenceRepo.save(new GroupReference("FT","CTA", "SGCIB Client Onboarding team","bookmarkApp",new Date(System.currentTimeMillis()))); 
			  ...
			  groupReferenceRepo.save(new GroupReference("FT","ONS", "SGCIB Client Onboarding team","bookmarkApp",new Date(System.currentTimeMillis()))); 
			  groupReferenceRepo.save(new GroupReference("FT","ATS", "SGCIB Client Onboarding team","bookmarkApp",new Date(System.currentTimeMillis()))); 
			  groupReferenceRepo.save(new GroupReference("FT","NOS", "SGCIB Client Onboarding team","bookmarkApp",new Date(System.currentTimeMillis()))); 
			  ...
			  groupReferenceRepo.save(new  GroupReference("APPLICATION","TPS", "Maestro Application","bookmarkApp",new Date(System.currentTimeMillis()))); 
			  groupReferenceRepo.save(new  GroupReference("APPLICATION","EDGE", "Maestro Application","bookmarkApp",new Date(System.currentTimeMillis()))); 
			  groupReferenceRepo.save(new  GroupReference("APPLICATION","RISQ", "Maestro Application","bookmarkApp",new Date(System.currentTimeMillis()))); 
