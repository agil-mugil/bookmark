...
CREATE TABLE IF NOT EXISTS TBOOKMARKGROUPSENG (
  ...
  DATMOD TIMESTAMP NULL NULL,
  PRIMARY KEY (GROUPID),
   UNIQUE INDEX GROUPTYPE_GROUPVALUE_UNIQUE (GROUPTYPEASC, GROUPVALUE ASC));
...
/* ALTER TABLE tbookmarkgroupseng 
...
ADD CONSTRAINT FK_GROUPREF_GROUPDATA
  ...
  REFERENCES tgrouprefdataeng (GROUPTYPE , GROUPVALUE)
  ON DELETE NO ACTION
  ON UPDATE NO ACTION;
  
ALTER TABLE tcardseng 
ADD INDEX FK_GROUP_CARDS_idx (GROUPID ASC);

ALTER TABLE tcardseng 
ADD CONSTRAINT FK_GROUP_CARDS
  FOREIGN KEY (GROUPID)
  REFERENCES tbookmarkgroupseng (GROUPID)
  ON DELETE NO ACTION
  ON UPDATE NO ACTION;

ALTER TABLE tgroupadminseng 
...
ADD CONSTRAINT FK_STATUS_CARDCHANGE
  FOREIGN KEY (STATUS)
  REFERENCES tstatuseseng (STATUSCODE)
  ON DELETE NO ACTION
  ON UPDATE NO ACTION;*/
