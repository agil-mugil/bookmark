...
public Class<Bookmark> bookmarkClass = Bookmark.class; 
	...
	void validateCreator() throws NoSuchFieldException, SecurityException {
		Field bookmarkField = bookmarkClass.getDeclaredField("creator");
		Column columnAnnotation = bookmarkField.getAnnotation(Column.class);
		assertNotNull(columnAnnotation);
	...
	void validateCreatedDate() throws NoSuchFieldException, SecurityException {
		Field bookmarkField = bookmarkClass.getDeclaredField("createdDate");
		Column columnAnnotation = bookmarkField.getAnnotation(Column.class);
		assertNotNull(columnAnnotation);
	...
	void validateModifier() throws NoSuchFieldException, SecurityException {
		Field bookmarkField = bookmarkClass.getDeclaredField("modifier");
		Column columnAnnotation = bookmarkField.getAnnotation(Column.class);
		assertNotNull(columnAnnotation);
	...
	void validateModifierDate() throws NoSuchFieldException, SecurityException {
		Field bookmarkField = bookmarkClass.getDeclaredField("modifiedDate");
		Column columnAnnotation = bookmarkField.getAnnotation(Column.class);
		assertNotNull(columnAnnotation);
	...
	void validateEraser() throws NoSuchFieldException, SecurityException {
		Field bookmarkField = bookmarkClass.getDeclaredField("eraser");
		Column columnAnnotation = bookmarkField.getAnnotation(Column.class);
		assertNotNull(columnAnnotation);
